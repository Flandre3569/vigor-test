...
function R$2(a2, b2, e2, d2, c2) {
  ...
  if (h2)
    return h2 = a2, c2 = c2(h2), a2 = "" === d2 ? "." + Q$1(h2, 0) : d2, I$2(c2) ? (e2 = "", null != a2 && (e2 = a2.replace(P$2, "$&/") + "/"), R$2(c2, b2, e2, "", function(a3) {
      return a3;
...
const t$1 = /* @__PURE__ */ getDefaultExportFromCjs(reactExports);
...
function dg(a2, b2, c2) {
  ...
  if (!d2)
    throw Error(p$2(169));
  c2 ? (a2 = bg$1(a2, b2, Xf), d2.__reactInternalMemoizedMergedChildContext = a2, E$1(Wf), E$1(H$1), G$1(H$1, a2)) : E$1(Wf);
  G$1(Wf, c2);
}
...
var mk = Math.ceil, nk = ua.ReactCurrentDispatcher, ok = ua.ReactCurrentOwner, pk = ua.ReactCurrentBatchConfig, K$1 = 0, R$1 = null, Y$1 = null, Z = 0, gj = 0, fj = Uf(0), T$1 = 0, qk = null, hh = 0, rk = 0, sk = 0, tk = null, uk = null, gk = 0, Hj = Infinity, vk = null, Pi = false, Qi = null, Si = null, wk = false, xk = null, yk = 0, zk = 0, Ak = null, Bk = -1, Ck = 0;
function L$1() {
...
function mh(a2, b2, c2, d2) {
  ...
  Ac(a2, c2, d2);
  if (0 === (K$1 & 2) || a2 !== R$1)
    a2 === R$1 && (0 === (K$1 & 2) && (rk |= c2), 4 === T$1 && Dk(a2, Z)), Ek(a2, d2), 1 === c2 && 0 === K$1 && 0 === (b2.mode & 1) && (Hj = B$1() + 500, fg && jg());
}
function Ek(a2, b2) {
...
function Hk(a2, b2) {
  ...
  if (0 !== (d2 & 30) || 0 !== (d2 & a2.expiredLanes) || b2)
    ...
    nk.current = f2;
    K$1 = e2;
    null !== Y$1 ? b2 = 0 : (R$1 = null, Z = 0, b2 = T$1);
  }
  if (0 !== b2) {
...
function Ui(a2, b2, c2) {
  ...
  R$1 === a2 && (Z & c2) === c2 && (4 === T$1 || 3 === T$1 && (Z & 130023424) === Z && 500 > B$1() - gk ? Lk(a2, 0) : sk |= c2);
  Ek(a2, b2);
}
function Zk(a2, b2) {
...
reactIs_production_min.isValidElementType = function(a2) {
  return "string" === typeof a2 || "function" === typeof a2 || a2 === e || a2 === m$1 || a2 === g$1 || a2 === f$1 || a2 === p$1 || a2 === q$1 || "object" === typeof a2 && null !== a2 && (a2.$$typeof === t || a2.$$typeof === r$1 || a2.$$typeof === h$1 || a2.$$typeof === k$1 || a2.$$typeof === n$1 || a2.$$typeof === w$1 || a2.$$typeof === x$1 || a2.$$typeof === y$1 || a2.$$typeof === v$1);
};
...
var Context = /* @__PURE__ */ t$1.createContext();
var LOADABLE_SHARED = {
  initialChunks: {}
};
...
var withChunkExtractor = function withChunkExtractor2(Component) {
  var LoadableWithChunkExtractor = function LoadableWithChunkExtractor2(props) {
    return t$1.createElement(Context.Consumer, null, function(extractor) {
      return t$1.createElement(Component, Object.assign({
...
function createLoadable(_ref) {
  ...
  function loadable2(loadableConstructor, options) {
    ...
    var Loadable = t$1.forwardRef(function(props, ref) {
      return t$1.createElement(EnhancedInnerLoadable, Object.assign({
        forwardedRef: ref
      }, props));
    });
...
var _createLoadable = /* @__PURE__ */ createLoadable({
  ...
  render: function render(_ref) {
    ...
    return t$1.createElement(Component, props);
  }
...
var lazy$2 = lazy;
lazy$2.lib = lazy$1;
const Route0 = loadable$2(() => __vitePreload(() => import("./quickStart-3364503a.js"), true ? [] : void 0));
const Route1 = loadable$2(() => __vitePreload(() => import("./index-f35f5f61.js"), true ? [] : void 0));
const routes = [
  { path: "/guide/quickStart", element: t$1.createElement(Route0), preload: () => __vitePreload(() => import("./quickStart-3364503a.js"), true ? [] : void 0) },
  { path: "/", element: t$1.createElement(Route1), preload: () => __vitePreload(() => import("./index-f35f5f61.js"), true ? [] : void 0) }
];
...
const contextData = reactExports.createContext({});
const useContextData = () => {
  return reactExports.useContext(contextData);
};
const base = "";
const vars = "";
const __uno = "";
...
function Nav() {
  ...
  return /* @__PURE__ */ jsx("header", { fixed: "~", w: "full", z: "10", className: styles$a.bgColor, children: /* @__PURE__ */ jsxs("div", { flex: "~", justify: "between", items: "center", className: "px-8 h-14 divider-bottom", children: [
    ...
    /* @__PURE__ */ jsxs("div", { flex: "~", children: [
      ...
      /* @__PURE__ */ jsx("div", {}),
      /* @__PURE__ */ jsx("div", { className: `${styles$a.socialLinkIcon} pl-3`, children: /* @__PURE__ */ jsx("a", { href: GITHUB_LINK_HREF, children: /* @__PURE__ */ jsx("div", { className: "i-carbon-logo-github w-5 h-5 fill-current" }) }) })
    ] })
  ] }) });
}
...
function HeroComponent(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { flex: "~", children: [
    /* @__PURE__ */ jsxs("div", { className: "w-1/2", children: [
      ...
      /* @__PURE__ */ jsx("div", { flex: "~", pt: "3", children: hero.actions.map((action) => /* @__PURE__ */ jsx("div", { className: "pr-3", children: /* @__PURE__ */ jsx(
        Button,
        {
          type: "a",
          text: action.text,
...
function FeatureComponent(props) {
  return /* @__PURE__ */ jsx("div", { flex: "~ wrap", justify: "between", pt: "8", className: "divider-bottom pb-10", children: props.features.map((feature) => {
    const {
      title: title2,
      details,
      icon = ""
    } = feature;
    return /* @__PURE__ */ jsx("div", { border: "rounded-md", pb: "1.3%", w: "32.4%", children: /* @__PURE__ */ jsxs("article", { p: "6", className: `${styles$6.bg} h-3/4`, children: [
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "px-24 pt-30 w-4/5 mx-auto my-0", children: [
...
function Sidebar(props) {
  ...
  const renderItems = (item2) => {
    var _a;
    return /* @__PURE__ */ jsxs("section", { className: "divider-bottom py-3", children: [
...
const prevPage = "_prev-page_39oef_1";
const nextPage = "_next-page_39oef_15";
const prevPageTitle = "_prev-page-title_39oef_31";
const nextPageTitle = "_next-page-title_39oef_37";
const prevPageContent = "_prev-page-content_39oef_43";
const nextPageContent = "_next-page-content_39oef_48";
const styles$3 = {
  prevPage,
  nextPage,
  prevPageTitle,
...
function NextPage() {
  ...
  return /* @__PURE__ */ jsx("footer", { children: /* @__PURE__ */ jsxs("div", { flex: "~", justify: "between", className: "py-5", children: [
    /* @__PURE__ */ jsx("div", { children: prevPage2 && /* @__PURE__ */ jsxs("a", { href: prevPage2.link, className: styles$3.prevPage, children: [
      /* @__PURE__ */ jsx("span", { className: styles$3.prevPageTitle, children: "上一页" }),
    ...
    /* @__PURE__ */ jsx("div", { children: nextPage2 && /* @__PURE__ */ jsxs("a", { href: nextPage2.link, className: styles$3.nextPage, children: [
      /* @__PURE__ */ jsx("span", { className: styles$3.nextPageTitle, children: "下一页" }),
...
function TocComponent(props) {
  ...
  const markRef = reactExports.useRef(null);
...
function DocPage() {
  var _a;
  const { siteData: siteData2, toc } = useContextData();
  ...
  return /* @__PURE__ */ jsxs("div", { flex: "~", children: [
    ...
    /* @__PURE__ */ jsxs("div", { pt: "22", w: "3/4", className: styles$1.vigorDoc, flex: "~", children: [
      /* @__PURE__ */ jsxs("div", { w: "2/3", className: "vigor-doc", children: [
        /* @__PURE__ */ jsx("article", { className: "container divider-bottom", children: /* @__PURE__ */ jsx(Content, {}) }),
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(NextPage, {}) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: styles$1.tocContainer, w: "1/4", h: "100vw", pl: "20", children: /* @__PURE__ */ jsx(TocComponent, { headers: toc }) })
    ] })
  ] });
}
...
const r = /* @__PURE__ */ getDefaultExportFromCjs(propTypesExports);
...
var l = { BASE: "base", BODY: "body", HEAD: "head", HTML: "html", LINK: "link", META: "meta", NOSCRIPT: "noscript", SCRIPT: "script", STYLE: "style", TITLE: "title", FRAGMENT: "Symbol(react.fragment)" }, p = { rel: ["amphtml", "canonical", "alternate"] }, f = { type: ["application/ld+json"] }, d = { charset: "", name: ["robots", "description"], property: ["og:type", "og:title", "og:url", "og:image", "og:image:alt", "og:description", "twitter:url", "twitter:title", "twitter:description", "twitter:image", "twitter:image:alt", "twitter:card", "twitter:site"] }, h = Object.keys(l).map(function(t2) {
  ...
  return r2.map(function(r3, n2) {
    ...
    }), t$1.createElement(e2, o2);
  });
}, M = function(e2, r2, n2) {
  switch (e2) {
    case l.TITLE:
      return { toComponent: function() {
        return n3 = r2.titleAttributes, (i2 = { key: e3 = r2.title })["data-rh"] = true, o2 = L(n3, i2), [t$1.createElement(l.TITLE, o2, e3)];
        var e3, n3, i2, o2;
      }, toString: function() {
...
}, R = t$1.createContext({}), D = r.shape({ setHelmet: r.func, helmetInstances: r.shape({ get: r.func, add: r.func, remove: r.func }) }), U = "undefined" != typeof document, q = /* @__PURE__ */ function(e2) {
  function r2(t2) {
    var n2;
  ...
  return s(r2, e2), r2.prototype.render = function() {
    return t$1.createElement(R.Provider, { value: this.helmetData.value }, this.props.children);
  }, r2;
...
var F = ["children"], G = ["children"], W = /* @__PURE__ */ function(e2) {
  ...
  return o2.shouldComponentUpdate = function(t2) {
    ...
    return i(h.some(function(e4) {
      return t2.type === e4;
    }), "function" == typeof t2.type ? "You may be attempting to nest <Helmet> components within each other, which is not allowed. Refer to our API for more information." : "Only elements types " + h.join(", ") + " are allowed. Helmet does not support rendering <" + t2.type + "> elements. Refer to our API for more information."), i(!e3 || "string" == typeof e3 || Array.isArray(e3) && !e3.some(function(t3) {
    ...
    var n2 = this, i2 = {};
    return t$1.Children.forEach(e3, function(t2) {
      if (t2 && t2.props) {
    ...
    return r3 && (i2 = this.mapChildrenToProps(r3, i2)), !o3 || o3 instanceof N || (o3 = new N(o3.context, o3.instances)), o3 ? /* @__PURE__ */ t$1.createElement(z, a({}, i2, { context: o3.value, helmetData: void 0 })) : /* @__PURE__ */ t$1.createElement(R.Consumer, null, function(e4) {
      return t$1.createElement(z, a({}, i2, { context: e4 }));
    });
  }, r2;
}(reactExports.Component);
...
function Layout() {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(W, { children: /* @__PURE__ */ jsx("title", { children: title2 }) }),
    /* @__PURE__ */ jsx(Nav, {}),
...
async function runderInBrowser() {
  ...
  createRoot(containerEl).render(
    // 自定义head
    /* @__PURE__ */ jsx(q, { children: /* @__PURE__ */ jsx(contextData.Provider, { value: pageData, children: /* @__PURE__ */ jsx(BrowserRouter, { children: /* @__PURE__ */ jsx(App, {}) }) }) })
  );
}
runderInBrowser();
export {
